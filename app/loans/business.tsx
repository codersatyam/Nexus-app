...
export default function BusinessLoan() {
  ...
  const validateForm = (amount: string, tenureMonths: string) => {
    const amountValid = parseInt(amount) >= 50000 && parseInt(amount) <= 5000000;
    const tenureValid = parseInt(tenureMonths) >= 3 && parseInt(tenureMonths) <= 60;
  ...
  const handleNext = () => {
    if (isFormValid) {
      router.push({
        ...
        params: { amount: loanAmount, tenure: tenure }
      });
    }
  };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Business Loan</Text>
      </View>

      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.formContainer}>
          <Text style={styles.sectionTitle}>Let's get you a business loan</Text>
          ...
          <View style={styles.inputSection}>
            ...
            <View style={styles.amountRangeInfo}>
              <Text style={styles.amountRangeText}>Amount Range: ₹50,000 - ₹50,00,000</Text>
            </View>
          </View>
